package org.atlanmod.vce.emfviews.example;
...
import org.atlanmod.vce.emfviews.helper.ModelHelper;
...
public class CreateView {
  ...
  public static void main(String[] args) throws IOException {
    ...
    map.put(UMLResource.FILE_EXTENSION, UMLResource.Factory.INSTANCE);
    ...
    // Load the resources
    URI umlModelUri = resourceURI("/ART-NG/AIDOaRt_Hackaton_ART-NG.uml");
    Resource model = resourceSet.getResource(umlModelUri, true);
    
    ModelHelper.printResource(model);
